...
public class CommonParameters extends InstallationTask {
    ...
    static Parameter[] preDefined = {
            new Parameter("targetpath", "the target path to install this installation into", true, "/temp/target",ParameterType.FOLDER,null,true),
            ...
            new Parameter("instllationspath", "where to find alien components installation files, for example Java installation. This is more relevant for Windows", true, parentFolder + "/resources/installations",ParameterType.FOLDER,Parameter::validateExistingFolder, false),
            new Parameter("scriptspath", "where to find  operating system scripts", true, parentFolder + "/scripts",ParameterType.FOLDER,Parameter::validateExistingFolder, false),
            new Parameter("filespath", "where to find  additional configuration files", true, parentFolder + "/files",ParameterType.FOLDER,Parameter::validateExistingFolder, false),
